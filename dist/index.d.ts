...
declare class DdServerApiByWeb {
     ...
     */
    requestT<T>(url: string, data?: any, method?: 'GET' | 'POST' | 'DELETE', requestType?: 'form' | 'json' | 'fileData'): Promise<T>;
    /**
     * 获取用户列表接口
     * @param pager 分页
     * @param user  查询条件
     ...
     * @returns 查询结果，单个对象
     */
    getResourceCategory(params: ResCategory): Promise<Result<ResCategory>>;
    /**
     * 获取资源子对象集合
     * @param id 分类ID
     */
